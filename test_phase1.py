...
import time  # 1. We imported time to help pause the screen

# Load the Environment
env = gym.make("Phase1Hover-v0", render_mode="human")

# Load the Brain
model = PPO.load("ppo_phase1_hover")

print("Starting the test flight!")
...
for ep in range(episodes):
    ...
    # 3. Pause for 2 seconds before the next episode starts
